...
typedef struct
{
	DWORD dwUsage;					// FOURCC timer_ usage ID
	DWORD dwValue;					// timer_ value in samples from head
} TAG_CART_TIMER;
...
HSYNC BASSDEF(BASS_ChannelSetSync)(DWORD handle, DWORD type, QWORD param, SYNCPROC *proc, EDJModeCDJ *user);
